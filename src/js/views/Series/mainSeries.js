...
export const MainSeries = () => {
	...
	const cardInfoViendo =[
		{image: img1,title: "WandaVision",text: "T01 - E07. Abajo la cuarta pared. Quedan por ver: +2"},
		{image: img6,title: "Stranger Things",text: "T04 - E01. El club Hellfire. Quedan por ver: +6"},
		{image: img2,title: "Dark",text: "T01 - E03. Pasado y presente. Quedan por ver: +7"},
	]
	...
	const renderCard = (card, index) => {
		return (
			<Card style={{ marginBottom: "20%", marginLeft: "2%", marginRight: "2%",width: "22.5rem", cursor: "pointer", backgroundColor: "#081826"}} key={index} className="box">
