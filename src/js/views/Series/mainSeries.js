...
export const MainSeries = () => {
	...
	const cardInfoViendo = [
		{
			...
			synopsis: "Monica planea volver a la anomalía. Wanda sortea obstáculos. Visión forja otra alianza para ayudar",
			about: "WandaVision combina el estilo cómico de situaciones clásicas con el Universo Cinematográfico de Marvel en el que Wanda Maximoff y Visión, dos seres superpoderosos que viven su vida suburbana ideal, comienzan a sospechar que no todo es lo que parece.",
		},
		{
			id: 1,
			image: img6,
			...
			synopsis: "Eleven sufre acoso escolar, pero no puede defenderse. Joyce abre un paquete misterioso. En Hawkins, alguien agita la noche de Calabozos y Dragones.",
			about: "Después de la extraña desaparición de un niño, un pueblo se encuentra ante un misterio que revela experimentos secretos, fuerzas sobrenaturales y a una niña muy especial.",
		},
		{
			id: 2,
			image: img2,
		...
		},
		{
			...
			synopsis: "La heredera desterrada Mel y su madre, de visita, intercambian tácticas de combate. Caitlyn y Vi forjan una inesperada alianza. Jinx se somete a un cambio impactante.",
	...
	const cardInfoSin = [
		{ id: 5, 
		  ...
		  episodio: "Episodio 1", 
		  nombre: "Parte 1",
		  synopsis: "Cuando los agentes del Imperio plantean una nueva amenaza, Obi-wan Kenobi emerge tras años de ocultamiento.", 
		  about: "Se centra en Obi-Wan Kenobi 10 años después del final de las Guerras Clon, donde enfrentó su mayor derrota: la caída y corrupción de su mejor amigo y aprendiz de Jedi, Anakin Skywalker quién se convirtió en el malvado Lord Sith Darth Vader." },
		{ id: 6,
	      image: img4, 
		  name: "Death Note", 
		  episodio: "Episodio 1", 
		  nombre: "Renacimiento",
		  synopsis: "Fuera de los terrenos de su instituto, Light Yagami descubre una libreta que afirma poder matar a cualquiera cuyo nombre y rostro sean conocidos por su propietario. Al principio descarta la llamada Death Note como un engaño, pero, tras probar sus poderes, descubre que efectivamente son reales. El propietario original, un shinigami llamado Ryuk, se acerca a Light y le explica que la libreta ahora le pertenece. Como Light es el nuevo propietario, es el único que puede ver y oír a Ryuk. El shinigami también dice que cuando llegue la hora de la muerte de Light, Ryuk escribirá el nombre de Light en su Death Note personal. Light decide usar el poder de la Death Note para librar al mundo del mal y convertirse en el dios de un mundo nuevo y pacífico.",
		  about: "Light Yagami es un joven estudiante que un día encuentra un cuaderno llamado Death Note que tiene una macabra propiedad: si el nombre de una persona aparece escrito en él, morirá. Light decide, entonces, embarcarse en una misión para librar al mundo de todos los criminales. Sin embargo, su plan empieza a torcerse cuando L, un brillante detective, intenta descifrar el misterio que rodea a todas estas muertes." },
		{ id: 7, 
		  image: img5, 
		  name: "Euphoria",
		  episodio: "Episodio 1", 
		  nombre: "Piloto",
		  synopsis: "Rue, regresa a casa de la rehabilitación sin planes de mantenerse limpia. Ahí conoce a Jules, que es nueva en la ciudad, en una fiesta en la casa de McKay. Nate se mete en la cabeza de McKay cuando el se interesa en Cassie. Mientras tanto, Kat es presionada para perder algo.",
		  about: "El drama estadounidense sigue a un grupo de adolescentes en sus conflictos internos relacionados con el sexo, el uso de drogas y la violencia. Ellos tratarán de lidiar con sus propios demonios, a fin de superar los obstáculos que se interponen en sus metas o, simplemente, en su día a día." },
		{ id: 8,
		  image: img7, 
		  name: "The Mandalorian",
		  episodio: "Episodio 1", 
		  nombre: "El mandaloriano",
		  synopsis: "Un cazarrecompensas mandaloriano rastrea un objetivo para un cliente buen pagador.",
		  about: "Ambientada en el universo de Star Wars que se desarrolla tras la caída del Imperio y antes de la aparición de la Primera Orden, la serie sigue los pasos de Mando, un cazarecompensas perteneciente a la legendaria tribu de los Mandalorian, un pistolero solitario que trabaja en los confines de la galaxia, donde no alcanza la autoridad de la Nueva República." },
		{ id: 9,
		  image: img8, 
		  name: "El Juego del Calamar",
		  episodio: "Episodio 1", 
		  nombre: "Luz roja, luz verde",
		  synopsis: "Con la esperanza de ganar dinero fácil, un Gi-hun quebrado y desesperado acepta participar en un juego enigmático. No mucho después de la primera ronda, se desarrollan horrores imprevistos.",
		  about: "Cientos de jugadores cortos de dinero aceptan una extraña invitación a competir en juegos infantiles. Adentro les espera un premio irresistible... con un riesgo mortal." },
	];
